...
nav_order: 4
description: "Bản đồ ổ dịch, dòng tin tức, cảnh báo khí hậu — và cách hệ thống lọc dữ liệu."
---
...
## 5. Cảnh báo khí hậu (Climate Panel)
...
## 6. Lọc dữ liệu — đây là phần quan trọng nhất
...
- **Lớp AI trong pipeline** — mỗi bài phải vượt qua cả ba câu hỏi: *đây có phải tin dịch thật cho người không? — có xảy ra ở Việt Nam không? — có ca/ổ dịch/cảnh báo cụ thể không?*. Trả lời "không" cho bất kỳ câu nào → bài bị loại.
...
## 8. Mở, miễn phí, tôn trọng người dùng
